export function Background() {
    return (
        <div
            ...
            className="h-[500px] md:h-[650px] text-5xl mt-16">
            <div className="bg-black h-full w-full bg-opacity-60 flex flex-col justify-center items-center">
                ...
                <button className="mt-10 px-6 md:px-10 py-3 md:py-5 bg-white text-blue-600 text-lg md:text-xl font-semibold hover:bg-blue-600 hover:text-white transition duration-300 rounded-full">
                    Explore Now
                </button>
            </div>
        </div>
